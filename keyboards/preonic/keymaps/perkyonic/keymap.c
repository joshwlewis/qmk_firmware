...
[QRT] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL,     KC_BSLS,     KC_LALT,     KC_LGUI,     LT(PRK, KC_MINS), KC_BSPC,     KC_SPC,      LT(PRK, KC_EQL),   KC_LEFT,      KC_DOWN,     KC_UP,       KC_RGHT   \
),
...
[DVK] = LAYOUT_preonic_grid( \
  ...
  KC_LCTL,     KC_BSLS,     KC_LALT,     KC_LGUI,     LT(PRK, KC_LBRC), KC_BSPC,     KC_SPC,      LT(PRK, KC_RBRC),  KC_LEFT,      KC_DOWN,     KC_UP,       KC_RGHT   \
),
...
[PRK] = LAYOUT_preonic_grid( \
  ...
  _______,     S(KC_NUHS),  S(KC_NUBS),  KC_BRID,     KC_BRIU,          _______,     _______,     KC_MPRV,           KC_MNXT,      KC_MPLY,     KC_PSCR,     MU_TOG,   \
